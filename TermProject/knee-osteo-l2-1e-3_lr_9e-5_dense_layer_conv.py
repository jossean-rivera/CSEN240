...
print('============================')
print('Current test:')
print('- L2 Regularization with penalty 1e-3')
print('- Set learning rate to 9e-5')
print('- Add one more dense layer with L2 regularization')
print('- Add convolutional layer before the dense layers')
print('============================')
...
def create_xception_model(input_shape, num_classes=8, learning_rate=1e-5):
...
cnn_model = create_xception_model(input_shape, num_classes=3, learning_rate=LR)
