...
print('============================')
print('Current test:')
print('- Set learning rate to 5e-5')
print('============================')
...
def create_xception_model(input_shape, num_classes=8, learning_rate=5e-5):
...
cnn_model = create_xception_model(input_shape, num_classes=3, learning_rate=5e-5)
