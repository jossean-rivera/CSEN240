...
|[knee-osteo_lr_2e-5.py](/TermProject/knee-osteo_lr_2e-5.py)|Set learning rate to 2e-5|[knee_base-.out](/TermProject/logs/knee_base-.out)|-|
|[knee-osteo_lr_3e-5.py](/TermProject/knee-osteo_lr_3e-5.py)|Set learning rate to 3e-5|[knee_base-.out](/TermProject/logs/knee_base-.out)|-|
|[knee-osteo_lr_7_5e-5.py](/TermProject/knee-osteo_lr_7_5e-5.py)|Set learning rate to 7.5e-5|[knee_base-.out](/TermProject/logs/knee_base-.out)|-|
|[knee-osteo_lr_8e-5.py](/TermProject/knee-osteo_lr_8e-5.py)|Set learning rate to 8e-5|[knee_base-.out](/TermProject/logs/knee_base-.out)|-|
|[knee-osteo_lr_9e-5.py](/TermProject/knee-osteo_lr_9e-5.py)|Set learning rate to 9e-5|[knee_base-.out](/TermProject/logs/knee_base-.out)|-|
